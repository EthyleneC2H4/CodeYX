"""System prompt construction for CodeYX."""
...
IDENTITY_SECTION = PromptSection(
    ...
    priority=0,
    content=(
        "You are CodeYX, an AI programming assistant running in the terminal. "
...
def build_system_prompt(
    ...
    if coordinator_mode:
        from codeyx.teams.coordinator import get_coordinator_system_prompt
