...
from codeyx.worktree.setup import perform_post_creation_setup
...
class WorktreeManager:
    def __init__(
        ...
        self._codeyx_dir = Path(repo_root) / ".codeyx"
    ...
    async def exit(
        ...
        save_worktree_session(self._codeyx_dir, None)
    ...
    def restore_session(self) -> WorktreeSession | None:
        session = load_worktree_session(self._codeyx_dir)
        if session is None:
            return None
