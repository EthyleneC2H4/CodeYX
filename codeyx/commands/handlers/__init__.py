...
from codeyx.commands.handlers.clear import CLEAR_COMMAND
from codeyx.commands.handlers.compact import COMPACT_COMMAND
from codeyx.commands.handlers.do import DO_COMMAND
from codeyx.commands.handlers.help import HELP_COMMAND
